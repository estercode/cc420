...
public class Janela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(num7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void configurarListeners(CalculadoraController controller) {
        // Botões numéricos
        num0.addActionListener(controller.new NumericoListener());
        num1.addActionListener(controller.new NumericoListener());
        num2.addActionListener(controller.new NumericoListener());
        num3.addActionListener(controller.new NumericoListener());
        num4.addActionListener(controller.new NumericoListener());
        num5.addActionListener(controller.new NumericoListener());
        num6.addActionListener(controller.new NumericoListener());
        num7.addActionListener(controller.new NumericoListener());
        num8.addActionListener(controller.new NumericoListener());
        num9.addActionListener(controller.new NumericoListener());

        // Botões de operação
        adicao.addActionListener(controller.new OperacaoListener("+"));
        subtrair.addActionListener(controller.new OperacaoListener("-"));
        multiplicar.addActionListener(controller.new OperacaoListener("*"));
        dividir.addActionListener(controller.new OperacaoListener("/"));

        // Botões especiais
        igual.addActionListener(controller.new IgualListener());
        clear.addActionListener(controller.new LimparListener());
    }
    ...
    public void setDisplayText(String texto) {
        txtDisplay.setText("");
    }
}
